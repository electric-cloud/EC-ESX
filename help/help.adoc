...
* You can download this utility from the \http://communities.vmware.com/community/vmtn/vsphere/automationtools/ovf.
* OVF manual is available \http://www.vmware.com/support/developer/ovf.
...
For some procedures you need to specify the Guest OS ID. Find these values \http://www.vmware.com/support/developer/converter-sdk/conv50_apireference/vim.vm.GuestOsDescriptor.GuestOsIdentifier.html.
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/create-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/clone-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/relocate-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/cleanup-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/snapshot-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/revert-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/poweron-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/poweroff-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/shutdown-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/suspend-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/createresourcefromvm-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/getvmconfiguration-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/import-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/export-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/registervm-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/cloudmanagergrow-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/cloudmanagershrink-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/listentity-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/deleteentity-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/createfolder-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/renameentity-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/moveentity-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/displayesxsummary-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/changecpumemallocation-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/addharddisk-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/addcddvddrive-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/editcddvddrive-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/listdevice-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/removedevice-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/listsnapshot-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/removesnapshot-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/use-cases/case-1/poweroff-log.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/createresourcepool-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/parameters/editresourcepool-panel.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/use-cases/case-1/create-config.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/use-cases/case-1/poweron-parameters.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/use-cases/case-1/consume-parameters.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/use-cases/case-1/cleanup-parameters.png[image]

==== PowerOff

Now that the resource has been deleted, create a PowerOff step and fill in the requested parameters.

image::cloudbees-common::cd-plugins/ec-esx/use-cases/case-1/poweroff-parameters.png[image]
...
image::cloudbees-common::cd-plugins/ec-esx/use-cases/case-1/poweron-log.png[image]

Cleanup output:

image::cloudbees-common::cd-plugins/ec-esx/use-cases/case-1/cleanup-log.png[image]
